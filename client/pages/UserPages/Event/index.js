  ...
  return (
    <SafeAreaView>
      ...
      <PageBody>
        ...
        <Spacer height={20} />
        <Image style={styles.eventImage} source={images[Math.floor(Math.random() * 5)]} />
        <Spacer height={20} />
        <SubText text={global.markerData.description} />
        <Spacer height={30} />

        <BubbleButton style={{ backgroundColor: "transparent", color: "blue" }} buttonText="Directions" btnOnPress={() => Linking.openURL(url) } />
        <BubbleButton style={{ backgroundColor: "#A9DE90"}} buttonText="RSVP" />
      </PageBody>
    </SafeAreaView>
  );
};
