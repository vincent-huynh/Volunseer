...
import { ScrollView, StatusBar, View, Modal, StyleSheet, Dimensions } from 'react-native';
    ...
    return <View style={{ flex: 1 }}>
        ...
        <ScrollView style={{ marginTop: SharedStyles.topPageMargin }}>
            <PageBody>
                ...
                <BubbleButton style={{ borderRadius: 10 }} btnOnPress={ showMap } buttonText="Set Location" />
        ...
        >
            <View style={styles.modalContainer}>
                <MapView style={styles.map} initialRegion={region} onRegionChangeComplete={setRegion}>
                    ...
                    />
                    <SelectionButton buttonText="Finish Location Selection" btnOnPress={() => { setIsMapOpen(!isMapOpen) }} />
                </MapView>
